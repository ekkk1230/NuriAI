...
export const MOCK_INQUIRIES: any[] = [
    {
        ...
        content: "안녕하세요! nuriAI 서비스로 '봄의 곤충' 대주제 계획안을 추출하고 있는데요. 이번 주차에는 '예술경험' 영역을 제외하고 '의사소통'과 '자연탐구' 2개 영역 위주로만 AI 학습 모델을 정렬하여 계획안을 생성하고 싶습니다. 특정 누리과정 영역을 선택 해제하는 필터 기능이 지원되는지 문의드립니다.",
        status: "PENDING",
    ...
    },
    {
        ...
        content: "AI가 생성해 준 계획안 퀄리티가 너무 좋아서 만족하며 사용 중입니다! 한 가지 궁금한 점이 있는데, '만 5세' 유아 대상 계획안으로 잘못 선택해서 생성을 완료했습니다. 이미 완성된 계획안의 연령 설정을 '만 3세'로 변경하여 AI 발문이나 기대 효과를 재추출하는 기능이 있을까요? 아니면 새로 생성권을 차감해야 하는지 답변 부탁드립니다.",
        status: "ANSWERED", 
